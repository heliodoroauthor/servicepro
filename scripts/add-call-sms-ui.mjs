...
// NOTE: The spin animation <style> uses JSX string syntax to keep CSS braces
// from being parsed as JSX expressions.
...
// Insert the call modal before the pets tab marker
